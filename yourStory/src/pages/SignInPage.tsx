         ...
         <div className="flex flex-col lg:flex-row w-10/12 lg:w-8/12 bg-[#FED7D8] rounded-xl mx-auto shadow-lg overflow-hidden">
            ...
            <div className="w-full lg:w-1/2 py-16 px-12"> 
                ...
                <form>
                   ...
                   <div className="mt-5">
                     <button className="w-full bg-[#69C0DC] rounded-full py-3 text-center text-white"onClick={AddUser}>تسجيل</button>
                     <ToastContainer 
                     position = {"top-center"}
                     autoClose = {false} 
                     closeOnClick= {true}
                  ...
                  <p className='pt-10 text-center text-white text-xl' >لديك حساب؟ <a className="font-semibold text-base text-[#212F54]  hover:underline"href="/LogInPage"> تسجيل دخول</a></p>
